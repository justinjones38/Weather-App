...
import { getDayOfWeek, getTimeByHour, getTimeByMinute, getWindSpeedDirection } from "./utils.js";
...
weatherForm.addEventListener("submit", (event) => {
    ...
    const fetchData = async (location, windSpeedUnit = `&wind_speed_unit=mph`, temperatureUnit = "&temperature_unit=fahrenheit", precipitationUnit = "&precipitation_unit=inch") => {
        try {
            ...
            fullhourlyForecastSection.className = "forecast-container hourly-table-section";
